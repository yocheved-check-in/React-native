      ...
      >
        {this.props.search && (
          <View style={{ flexDirection: "row", height: 55 }}>
            ...
            >
              <Icon
                name={this.props.searchIconName || "md-search-sharp"}
                color={this.props.searchIconColor || this.props.iconColor}
                size={this.props.searchIconSize || this.props.iconSize || 25}
              />
            </View>
            <TextInput
              style={{
        ...
        <ScrollView
          style={[
            { padding: 5, height: this.props.scrollViewHeight },
