...
// const insertDataToSpaList = (props) => {
//   console.log(props.spaList.length);
//   //console.log("props.spaList" + Object.entries(props.spaList));
//   if (!props.spaList.length) {
//     exampledata.map((category) => {
//       category.items.map((item) => {
//         sortLengthArray(item);
//       });
//     });

//     props.createSpaList(exampledata);
//   }
// };
...
export default connect(mapStateToProps, mapDitpatchToProps)(SpaScreen);
